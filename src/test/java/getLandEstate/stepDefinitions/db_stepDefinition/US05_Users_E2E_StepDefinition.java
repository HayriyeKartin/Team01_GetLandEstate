...
import static getLandEstate.stepDefinitions.api_stepDefinition.US05_UserController_E2E_StepDefinition.userId;
import static getLandEstate.utilities.DB_Utilty.*;
import static org.junit.Assert.assertEquals;

public class US05_Users_E2E_StepDefinition {
    ...
    public void kayitliUserDatalariDogrulanir() {
        ...
        assertEquals(userId, ((Long) data.get("id")).intValue());
    ...
    public void kayitliUserSilindigiDogrulanir() {
        try (Connection connection = createStatement().getConnection()) {
            String selectQuery = "SELECT email FROM users WHERE email = 'tester@gulsum.com'";
